#ifndef DEFOCUSED_VISUAL_SERVOING_RAL_H
#define DEFOCUSED_VISUAL_SERVOING_RAL_
...
class Defocused_Visual_Servoing_RAL : public Visual_Servoing
{
public: 
    Defocused_Visual_Servoing_RAL(int resolution_x, int resolution_y, std::string depth_strategy = "constant", double depth_constant_val = 0.24);
